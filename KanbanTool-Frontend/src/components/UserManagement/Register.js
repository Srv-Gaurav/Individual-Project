...
class Register extends Component {
    ...
    render() {
        ...
        return (
            <div style={{ backgroundImage: "url(./1.jpg)", width:'100%', height:'100%' } }>
                            <div className="register" >
                <div className="container">
                    <div className="row">
                        <div className="col-md-8 m-auto">
                            <h1 className="display-4 text-center text-light">Register</h1>
                            <p className="lead text-center text-light">Begin your Journey</p>
